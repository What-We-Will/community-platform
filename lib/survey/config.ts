...
const severanceNegotiationSurvey: SurveyConfig = {
  ...
  questions: [
    ...
    },
    {
      ...
      type: "dropdown",
      section: "closing",
      label: "Please share your severance amount (optional):",
      required: false,
      storageTarget: "responses",
      encrypted: false,
      options: [
    ...
    },
    {
      ...
      type: "numeric",
      section: "closing",
      label: "How many years have you worked at {companyName}?",
      required: false,
      storageTarget: "responses",
      encrypted: false,
      min: 0,
    ...
    {
      id: "collective_negotiation",
      type: "single-select",
      section: "closing",
      label: "Would you consider withholding signing severance until there can be collective negotiation for better terms?",
      required: true,
      storageTarget: "sensitive",
      encrypted: false,
    ...
    },
    {
      ...
      type: "short-answer",
      section: "closing",
      label: "Can we reach out to you about our plans and progress? (Optionally include your email)",
      required: false,
      storageTarget: "sensitive",
      encrypted: true,
    },
    {
      ...
      type: "free-text",
      section: "closing",
      label: "Please share anything else you would like about the impact of the layoff on you and your family. We want to hear your thoughts and experience.",
      required: false,
      storageTarget: "responses",
      encrypted: true,
      maxLength: 10000,
